...
/**
 * Multipart upload for `POST /organizer-applications/me/documents` with upload progress (browser).
 */
export function useOrganizerDocumentUpload() {
  ...
  function uploadDocument(
    ...
    const url = `${config.public.apiBase}/organizer-applications/me/documents`
