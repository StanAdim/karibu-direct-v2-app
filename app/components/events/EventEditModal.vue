...
import type { Event, EventUpdateInput, EventVisibility } from '~/types'
...
const emit = defineEmits<{
  ...
  updated: [payload: EventUpdateInput]
}>()
...
const form = reactive<EventUpdateInput>({
  title: '',
  description: '',
  short_description: '',
  start_date: '',
...
function resetFormFromEvent(event: Event) {
  ...
  form.venue = {
    ...
    virtual_url: event.venue.virtual_url,
    virtual_platform: event.venue.virtual_platform
  }
  form.visibility = event.visibility
  form.capacity = event.capacity
  form.categories = event.categories
...
function handleSubmit() {
  ...
  const payload: EventUpdateInput = { ...form }
    ...
    <div class="flex max-h-[80vh] flex-col gap-6 overflow-y-auto">
      <header class="space-y-2">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          Adjust the core information, schedule, venue and settings for your event.
        </p>
      </header>
      ...
      >
        ...
        <div class="space-y-6 ">
          ...
          <EventCategoriesMultiSelect
            ...
            hint="Choose one or more categories for discoverability"
          />
        ...
        <div class="space-y-6">
          ...
          <div class="space-y-2">
            ...
            <div class="flex flex-wrap gap-3">
              <button
                ...
                @click="form.venue = { ...(form.venue || {}), type: type.value }"
              >
                <UIcon
                  :name="type.icon"
                  class="h-4 w-4"
          ...
          <div
            v-if="form.venue && form.venue.type !== 'virtual'"
          ...
          <div
            v-if="form.venue && form.venue.type !== 'physical'"
            class="grid gap-6 sm:grid-cols-2"
          >
            <AppInput
